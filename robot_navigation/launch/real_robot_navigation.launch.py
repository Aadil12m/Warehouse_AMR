...
def generate_launch_description():
    ...
    # 2. Nav2 Bringup (Navigation Stack)
    ...
    # 3. RViz2 (Default: false on RPi; run on remote PC instead)
    rviz_node = Node(
        package='rviz2',
        executable='rviz2',
        name='rviz2',
    ...
    return LaunchDescription([
        ...
        DeclareLaunchArgument('map', default_value=os.path.join(pkg_navigation, 'maps', 'map1.yaml'), description='Full path to map file for localization'),
